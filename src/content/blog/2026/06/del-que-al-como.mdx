...
Muchos desarrolladores describen con precisión qué quieren construir, pero dedican muy poco tiempo a definir cómo consideran que ese problema debe resolverse; esta es realmente la parte dificl de crear soluciones. La consecuencia es que terminan delegando mucho más que la implementación. Terminan delegando el **criterio**.
