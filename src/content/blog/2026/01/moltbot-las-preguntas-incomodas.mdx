---
title: 'Moltbot: las preguntas incómodas'
...
Hay un hype interesante alrededor de ~~ClawdBot~~ [Moltbot](https://www.molt.bot/).
...
Moltbot no destaca por una capacidad aislada.
...
Moltbot empuja, quiera o no, a salir de una lógica muy cómoda:
...
Moltbot es como una sierra caladora.
...
No porque todos deban instalar Moltbot.
...
Este no es un llamado a usar Moltbot.
