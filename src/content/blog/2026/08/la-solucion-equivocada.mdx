...
Pero también introduce un riesgo del que estamos hablando mucho menos:
...
Tenemos que hablar con las personas involucradas. Comprender el contexto. Identificar restricciones. Explorar alternativas. Decidir qué vamos a hacer y, quizás igual de importante, qué no vamos a hacer.
...
Pero quizás esa no sea la mejor forma de utilizar la capacidad que acabamos de ganar.
...
Antes solíamos decir que el trabajo más importante ocurría antes de escribir la primera línea de código. Eso sigue siendo cierto. La única diferencia es que ahora, en muchos casos, construir comienza con un prompt.

El primer prompt tampoco debería ser el principio del proceso.
...
¿Por qué estamos resolviendo este problema?
