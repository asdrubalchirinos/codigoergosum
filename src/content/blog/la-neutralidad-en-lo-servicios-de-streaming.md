...
Pues bien, esta es la situación con los servicios de streaming en la actualidad. Los consumidores se ven obligados a suscribirse a múltiples servicios de streaming si quieren ver alguno de sus contenidos. Esto se debe a que los grandes estudios y productoras han otorgado derechos exclusivos sobre títulos clave a distintas plataformas o peor aún han creado sus propias plataformas.

Por ejemplo, si quieres ver "Stranger Things" no te queda más remedio que suscribirte a Netflix. Para disfrutar de "The Mandalorian" y el resto del contenido de Star Wars, tienes que pagar un plan de Disney+. ¿Fan de "Game of Thrones" y "Succession"? HBO Max es tu única opción. Y así continuamente, creando "feudos" de contenido exclusivo.
...
Es hora de que las plataformas de streaming compitan en igualdad de condiciones, ofreciendo el mejor servicio posible sin abusar de feudos de contenido cautivo. Que el consumidor pueda elegir libremente basado en mérito, no obligado por dónde están encerrados sus programas favoritos.

Una solución sería prohibir los acuerdos exclusivos y requerir que todo el contenido esté disponible en cualquier servicio que quiera adquirir las licencias, permitiendo una auténtica competencia por calidad y valor. Los consumidores podrían entonces comparar plataformas y elegir según sus necesidades sin verse secuestrados por monopolios artificiales.

Es el momento de desmantelar estos feudos de contenido y liberar el mercado del streaming para una verdadera competencia justa basada en los méritos de cada servicio. Al final, serían los grandes beneficiados los consumidores que podrían ejercer su poder de elección en un terreno parejo.
